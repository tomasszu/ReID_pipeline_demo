...
parser.add_argument('--name', default='veri+vehiclex_str1+lin256+colJit',
...
parser.add_argument("--checkpoint", default="/home/toms.zinars/tomass/ReID_pipeline/vehicle_reid_repo2/vehicle_reid/model/veri+vehiclex_str1+lin256+colJit/net_19.pth")
